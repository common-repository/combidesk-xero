...
class Application {
	...
	public function __construct() {
		$this->plugin_name         = 'combidesk-xero';
		$this->plugin_product_name = __( 'Xero', $this->plugin_name );
		...
		$this->description = __( 'Synchronize your WooCommerce orders automatically to Xero', $this->plugin_name );
		$this->run();
	}
	...
	public function woo_hpos_compatibility() {
		if ( class_exists( \Automattic\WooCommerce\Utilities\FeaturesUtil::class ) ) {
			\Automattic\WooCommerce\Utilities\FeaturesUtil::declare_compatibility( 'custom_order_tables', 'combidesk-xero/combidesk-xero.php', true );
		}
	}
	...
	function add_combidesk_page() {
		...
		$menu_slug  = 'combidesk-xero-settings';
	...
	function combidesk_settings() {
		...
		echo '
		  ...
		  <form class="combidesk__cta-form" action="https://combidesk.com/combipackageinstall/woocommerce-xero" method="GET" target="_BLANK">
		  ...
		  <form class="combidesk__cta-form" action="https://refer.xero.com/ywm05tjl9dox" method="GET" target="_BLANK">
	...
	function load_combidesk_plugin_style( $hook ) {
		if ( $hook != 'toplevel_page_combidesk-xero-settings' ) {
			return;
		}
